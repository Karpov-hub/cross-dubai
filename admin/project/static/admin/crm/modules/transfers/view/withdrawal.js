Ext.define("Crm.modules.transfers.view.templates.withdrawal", {
  ...
  build() {
    return `
          <ul>
              ${this.tpl}
              <tpl if="data.options.bankname">
              
              <li>Bank: <span>{data.options.bankname}</span></li></tpl>
              ...
              <li>IBAN: <span>{data.options.iban} <tpl if="data.options.iban_currency">({data.options.iban_currency})</tpl></span></li>
