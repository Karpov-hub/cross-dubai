				...
				me.autoReconnectTask = Ext.TaskManager.start ({
					run: function () {
						...
						if (me.getStatus () === me.CLOSED) {
							me.reconnectAttemptions++;
							if(me.reconnectAttemptions >= me.reconnectAttemptionsLimit)
								D.c('Connection lost', 'Try reconnect now?', [], ()=> {
									me.initWebsocket ();
								})
							else
								me.initWebsocket ();
