 ...
 */
Ext.define("Core.print.renderers.Base", {
  /**
   * Prints the component
   * @param {Ext.Component} component The component to print
   */
  print: function(component, title) {
    var name =
      "print"; /*component && component.getXType
    ...
    win.document.write(this.generateHTML(component, title));
    win.document.close();
   ...
   */
  generateHTML: function(component, title) {
    return new Ext.XTemplate(
      '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">',
      "<html>",
      "<head>",
      '<meta content="text/html; charset=UTF-8" http-equiv="Content-Type" />',
      '<link href="classic/resources/Admin-all_1.css' +
        "?" +
        new Date().getTime() +
        '" rel="stylesheet" type="text/css" media="screen,print" />',
      '<link href="classic/resources/Admin-all_2.css' +
        "?" +
        new Date().getTime() +
        '" rel="stylesheet" type="text/css" media="screen,print" />',
      '<link href="classic/resources/Admin-all_3.css' +
        "?" +
        new Date().getTime() +
        '" rel="stylesheet" type="text/css" media="screen,print" />',
      "<title>" + (title || this.getTitle(component)) + "</title>",
      "</head>",
      "<body>",
      '<div id="csscheck"></div>',
   ...
   */
  generateBody(component) {
    return component.el.dom.innerHTML;
  },
   ...
   */
  stylesheetPath: "print/print.css"
});
