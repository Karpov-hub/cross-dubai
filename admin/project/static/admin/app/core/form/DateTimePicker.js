  ...
  initEvents: function() {
    ...
    Ext.apply(me.keyNavConfig, {
      up: function(e) {
        if (e.ctrlKey) {
          if (e.shiftKey) {
            me.minuteSlider.setValue(
              me.minuteSlider.getValue() + Number(this.minutesIncrement)
            );
          } else {
            me.showNextYear();
          }
          ...
          if (e.shiftKey) {
            me.hourSlider.setValue(
              me.hourSlider.getValue() + Number(this.minutesIncrement)
            );
          } else {
      ...
      Ext.Object.merge(
        {
          ...
          focusable: false,
          value: 0,
          increment: this.minutesIncrement,
          minValue: 0,
          maxValue: 59,
          vertical: true
        },
